...
void hanoi(int nbDisques, char depart, char intermediaire, char arrivee) {
     ...
     */
    if (nbDisques == 1) {
        printf("Deplacer le disque %d de %c a %c\n", nbDisques, depart, arrivee);
        return;
    }
    hanoi(nbDisques-1, depart, intermediaire, arrivee);
    printf("Deplacer le disque %d de %c a %c\n", nbDisques, depart, arrivee);
    return hanoi(nbDisques-1, intermediaire, arrivee, depart);
}
...
void hanoiNbDeplacements (int nbDisques, char depart, char intermediaire, char arrivee, int& cpt) {
    ...
    cpt = cpt + 1;
    printf("Deplacer le disque %d de %c a %c\n", nbDisques, depart, arrivee);
    return hanoiNbDeplacements(nbDisques-1, intermediaire, arrivee, depart,cpt);
}
